      ...
      <div className="prose prose-neutral max-w-none space-y-8 text-neutral-600">
        ...
        <section>
          ...
          <p>
            ...
            RCS de Tours<br />
            Email : isa.seb.gaud@gmail.com<br />
        ...
        <section>
          ...
          <p>
            <strong className="text-neutral-900">Jordan Thivault</strong><br />
        ...
        <section>
          ...
          <p>
            L’ensemble du contenu de ce site (textes, images, logos) est protégé
        ...
        <section>
          ...
          <p>
            Conformément à la loi Évin, la vente d’alcool est interdite aux
        ...
        <section>
          ...
          <p>
            En cas de litige, vous pouvez recourir à une médiation
            conventionnelle ou à tout autre mode alternatif de règlement des
            différends. Plateforme européenne de règlement des litiges :{" "}
            <a
