...
export default async function ProductsPage({ searchParams }: ProductsPageProps) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 pt-20 lg:pt-26">
      ...
      {/* Filtres catégories */}
      <Suspense fallback={<div className="mb-8 flex gap-2">{Array.from({ length: 3 }).map((_, i) => <div key={i} className="h-6 w-20 rounded-full bg-neutral-100 animate-pulse" />)}</div>}>
