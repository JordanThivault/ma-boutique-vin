...
export default function ProfilePage() {
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 pt-20 sm:px-6 lg:px-8 lg:pt-26">
      <div className="mb-8">
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border bg-white p-6">
          ...
          <div>
            ...
            />
            <p className="mt-2 text-xs text-neutral-400">L&apos;email ne peut pas être modifié.</p>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-red-100 bg-white p-6">
          <h2 className="mb-2 font-semibold text-red-600">Zone de danger</h2>
